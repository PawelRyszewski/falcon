...
if (strlen($description) == 0) {
    $description = "Blog o narzędziach AI - recenzje, poradniki i rankingi najlepszych aplikacji.";
}

if (strlen($title) == 0) {
    $title = "Narzędzia AI - blog i ranking";
}

if (strlen($keywords) == 0) {
    $keywords = "narzędzia AI, sztuczna inteligencja, ranking narzędzi AI, zarabianie na AI";
}
