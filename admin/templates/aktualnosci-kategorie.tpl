    ...
    <div class="content">
        <div class="row mb-4">
            <div class="col-12 col-lg">
                <h1 class="main-title"><span> Lista kategorii - aktualność</span></h1>
            </div>
                                ...
                                {foreach from=$categories item=item key=key name=name}
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/admin/aktualnosci/kategorie-edytuj/{$item.id}" class="orange hover-opacity">
                                                <span class="icon-content-edit"></span>
                                            </a>
                                        </td>
                                        <td class="text-center">
                                            <a href="/admin/aktualnosci/kategorie-usun/{$item.id}" class="red hover-opacity text-center">
