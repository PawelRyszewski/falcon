				...
				<div class="imglist row row-cols-3 row-cols-sm-3 row-cols-md-6 g-6">
					...
					<div class="col">
						<div class="card shadow-sm">
							{if $gallery.id == 111}
							<a href="/ai-materials/uploads/{$image.name}" data-fancybox="preview" class="linked-img text-center">
								<img class="hover-shadow" src="/ai-materials/uploads/thumb/{$image.name}" alt="{$image.title}" title="{$image.title}"  style="max-height: 220px;">
							</a>
							{else}
