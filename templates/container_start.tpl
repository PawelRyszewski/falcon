...
<section class="hero" id="top">
  ...
  <div class="wrap">
    ...
    <div class="hero-strip">
      <span>Kuchnia halal</span><span>Kierowcy muzułmanie</span><span>Hotele 5★</span><span>Concierge 24/7</span>
    </div>
  </div>
</section>

<!-- ===== PILLARS ===== -->
<section class="pillars" id="dlaczego">
  <div class="wrap">
...
<!-- ===== NATURE GALLERY ===== -->
<section class="gallery-sec" id="polska">
  <div class="wrap">
    <div class="sec-head" data-aos="fade-up">
...
<section id="pakiety">
  <div class="wrap">
    ...
    <div class="pkg-grid">
      ...
      <div class="pkg featured" data-aos="fade-up" data-aos-delay="80">
        ...
        <div class="pkg-body"><ul>
          ...
          <li>Tatry, Pieniny, spływ Dunajcem, zielone doliny</li>
          <li>Rejs po krystalicznych jeziorach Mazur</li>
    ...
    <div class="grand" data-aos="fade-up">
      <div class="grand-bg"></div><div class="grand-veil"></div>
      <div class="grand-in">
...
<section class="included">
  <div class="wrap">
    <div class="sec-head" data-aos="fade-up"><span class="eyebrow">Jak to działa</span><h2>Cztery kroki do podróży marzeń</h2></div>
    <div class="steps">
      <div class="step" data-aos="fade-up"><div class="dot">1</div><h4>Rozmowa</h4><p>Poznajemy Wasze marzenia, termin, liczbę osób i preferencje.</p></div>
      <div class="step" data-aos="fade-up" data-aos-delay="80"><div class="dot">2</div><h4>Projekt podróży</h4><p>Tworzymy spersonalizowany plan z hotelami, trasą i atrakcjami.</p></div>
      <div class="step" data-aos="fade-up" data-aos-delay="160"><div class="dot">3</div><h4>Rezerwacja</h4><p>Potwierdzamy każdy detal i zajmujemy się całą organizacją.</p></div>
      <div class="step" data-aos="fade-up" data-aos-delay="240"><div class="dot">4</div><h4>Podróż</h4><p>Witamy na lotnisku i opiekujemy się Wami przez cały pobyt.</p></div>
    </div>
  </div>
</section>
...
<section class="cta" id="kontakt">
  ...
  <div class="wrap">
    ...
    <div class="contact-row">
      ...
      <a class="contact-card" href="mailto:falconestpoland@gmail.com"><svg class="ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="5" width="18" height="14" rx="2"></rect><path d="M3 7l9 6 9-6"></path></svg>falconestpoland@gmail.com</a>
    </div>
  </div>
</section>
...
{literal}
<script defer src="/utils/js/falcon-home.js"></script>
{/literal}
